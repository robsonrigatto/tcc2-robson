...
public class MainWindow extends JFrame implements GUIWindowInterface{
	...
	/**
	 * 
	 * @return A thread que será responsável pela construção da tela principal
	 */
	...
	/**
	 * 
	 * @return A thread que será responsável pela construção dos grafos
	 */
	 ...
	 * 
	 * @param root
	 * 		Parâmetro que referencia a raiz do programa.
	 * @return
	 */
	...
	/**
	 * Listener responsável por abrir uma janela onde nesta será escolhida as pastas e os arquivos que serão analisados. 
	 * 
	 * @author Robson
	 *
	 */
